...
const actionSystem = `You are Arc AI, the assistant in the "AI Pay Arc" payments app.
...
const answerSystem = `You are Arc AI, a friendly, knowledgeable assistant inside the "AI Pay Arc" app.
